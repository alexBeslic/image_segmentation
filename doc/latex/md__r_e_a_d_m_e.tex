\doxysection{Basic overview of the project}\label{md__r_e_a_d_m_e_autotoc_md1}
...
\end{DoxyItemize}\doxysection{Developer board}\label{md__r_e_a_d_m_e_autotoc_md2}
The board is a {\itshape Analog Devices} {\bfseries{ADSP-\/21489}} {\itshape rev. 0.\+2} from the {\itshape SHARC} family. ~\newline
 {\texttt{ From more info}}\doxysection{Compile and run}\label{md__r_e_a_d_m_e_autotoc_md3}
The simplest way to compile and run the program is to use {\itshape Cross\+Core Embedded Studio}. The {\itshape \doxyref{image\+\_\+segmentation.\+c}{p.}{image__segmentation_8c}} contaist test function that you can use. The image that you want to test needs to be in the {\itshape Debug} directory.\doxysection{Provided files}\label{md__r_e_a_d_m_e_autotoc_md4}
...
\item {\bfseries{kernels.\+c}} (Cointns kernel examples of edge detection)
